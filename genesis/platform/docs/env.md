...
| ---------------------------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `DOMAIN`                     | `plat.localtest.me`             | The platform's domain; every app gets a subdomain of it (`packages/opd/src/cli.ts:116`).                                                                                   |
...
| `SEED`                       | unset                           | Seed tarball path for `op germinate`, as an alternative to the positional argument (`packages/opd/src/cli.ts:161`).                                                       |
| `OP_SRC`                     | unset                           | A managed clone of `plat/opd`; when set, `op up` runs supervised and a merge to `plat/opd` re-execs the daemon from its own source (`packages/opd/src/cli.ts:123`).       |
